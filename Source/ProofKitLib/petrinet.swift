...
public struct Petrinet {
  ...
  static public func add_edge(_ place: Term, _ transition: Term, _ weight: Term, _ isInput: Term, _ subnet: Term) -> Term {
    return Map(["place": place, "transition": transition, "weight": weight, "isInput" : isInput, "subnet": subnet])
  }
...
public func test_petrinets() {
  ...
  let net = Petrinet.add_edge(Nat.n(1), Nat.n(1), Nat.n(1), Boolean.True(), Petrinet.empty())
